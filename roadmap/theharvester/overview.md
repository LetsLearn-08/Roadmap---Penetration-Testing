...
- [`harvester.md`](./harvester.md)  
  Full tool guide: usage, flags, workflow, troubleshooting, and ethical reminders.

- [`commands.md`](./commands.md)  
  Step-by-step walkthrough with sample scans and documentation instructions.

- [`cheatsheet.md`](./cheatsheet.md) *(optional)*  
  Quick reference for common flags and syntax.
...
- Save output with `-f` and review in browser.
- Document findings and link to next phase tools.
